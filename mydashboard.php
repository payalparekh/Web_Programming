...
<html lang="en">
    <head>
        ...
        #footer{
         ...
         .spring-green-button{
            background: linear-gradient(135deg, #7201bd, #97cc11);
            color: #fff;
         }
         /*Button 4: Royal Purple */
         .royal-purple-button{
            background: login-container(135deg,#7c53c3,#a44bc5);
            color: #fff;
         }
         /*Button 5: Ruby Red*/
         .ruby-red-button{
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <nav id="sidebar" class="col-md-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><a href="https://sites.google.com/d/1rD9w4lH6J2CDiXvwoZeKqt4vp60jjGRJ/p/1oJiz3imNr5bTQP2uZBfP800DS6iAl4fQ/edit" target="_blank">Google sites</a></li>
                        <li class="list-group-item"><a href="https://www.linkedin.com/in/payal-parekh-a88b722a7/" target="_blank">LinkedIn</a></li>
                        <li class="list-group-item"><a herf="" target="_blank">Blog</a></li>
                        <li class="list-group-item"><a href="https://github.com/payalparekh/Web_Programming" target="_blank">GitHub</a></li>
                     </ul>
                </nav>
                <!-- Main Content-->
                <main class="col-md-9">
                 <div id="header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="" alt="Logo" width="100" class="float-right">
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        ...
                        <div class="dashboard-item">
                            <div id="assignments" class="section-title">
                                ...
                                <div class="btn-group">
                                 <button class="ocean-blue-button gradient-button"><a href=">Task 1</button>
                    ...
                    <div class="dashboard-item">
                      ...
                      <p>Details about your project goes here</p>
                    </div>
                </div>
             </main>
        </div>
